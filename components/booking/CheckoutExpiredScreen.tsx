    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1 items-center justify-center px-6">
        ...
        <Text className="mt-3 text-center text-[14px] leading-6 text-[#6B6B6B]">
          O tempo para pagar terminou e não te cobrámos nada. O horário voltou a ficar livre — podes
          reservar de novo.
        </Text>
        ...
        <Pressable
          ...
          <Text className="text-[14px] font-semibold text-[#171717]">Reservar novamente</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
